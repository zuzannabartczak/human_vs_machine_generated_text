...
with open('data_json/SubtaskA/subtaskA_train_monolingual.jsonl', 'r') as json_file, open('data_csv/subtaskA_train_monolingual.csv', 'w', newline='', encoding='utf-8') as csv_file:
